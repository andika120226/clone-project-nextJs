  ...
  },
  {
    ...
    icon: (
      <svg
        ...
        aria-hidden="true"
      >
        <path d="M12 2a9 9 0 0 0-9 9 8.92 8.92 0 0 0 1.6 5.12L3 22l5.99-1.57A9 9 0 1 0 12 2Zm0 16a6.9 6.9 0 0 1-2.88-.62l-.42-.2-2.1.55.55-2.02-.24-.4A7 7 0 1 1 12 18Zm3.82-5.24c-.21-.1-1.26-.62-1.45-.69-.19-.07-.33-.1-.47.1s-.54.69-.66.84c-.12.14-.24.16-.45.05-.21-.1-.88-.33-1.68-1.04-.62-.55-1.04-1.23-1.16-1.43-.12-.2-.01-.31.09-.42.09-.09.21-.24.31-.36.1-.12.14-.2.21-.34.07-.14.03-.26-.02-.36-.05-.1-.47-1.14-.64-1.56-.17-.4-.34-.35-.47-.36h-.4c-.14 0-.36.05-.56.26s-.73.71-.73 1.73.75 2 1.85 3.36c1.29 1.58 2.9 2.43 4.4 2.63.49.07.93.06 1.28-.02.39-.09 1.2-.49 1.37-.97.17-.48.17-.89.12-.97-.05-.09-.19-.14-.4-.24Z" />
      </svg>
    ),
  },
];
